...
// Module hierarchy
bool is_ancestor_module(const char **ancestor_path, u32 ancestor_len, const char **descendant_path, u32 descendant_len);
const char **get_relative_path(const char **from_path, u32 from_len, const char **to_path, u32 to_len);
